...
-- Reportar DNI, nombre, apellido, fecha de nacimiento y 
-- localidad donde viven de aquellos podadores con apellido terminado con el string ‘ata’ y 
-- que tengan al menos una poda durante 2024. Ordenar por apellido y nombre

SELECT DNI, nombre, apellido, fnac, nombreL FROM podador poda
WHERE apellido LIKE '%ata' AND DNI IN (
    SELECT DNI FROM poda
