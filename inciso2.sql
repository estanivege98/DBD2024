...
--Reportar DNI, nombre, apellido, fecha de nacimiento y localidad donde viven de aquellos podadores que 
-- tengan podas realizadas durante 2023. --

SELECT po.DNI, po.nombre, po.apellido, po.fnac, l.nombreL FROM podador po
